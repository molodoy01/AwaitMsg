...
const russianEditorialOverrides: Partial<Record<string, string>> = {
  ...
  'settings.telegramCredentials': 'Данные Telegram API',
  'settings.credentialsReady': 'ГОТОВО',
  'settings.credentialsMissing': 'НУЖНО',
  'settings.telegramCredentialsDescription': 'Создайте API_ID и API_HASH на my.telegram.org и сохраните их здесь. Они остаются в зашифрованном локальном хранилище.',
  'settings.telegramCredentialsReadFailed': 'Не удалось прочитать состояние данных Telegram API.',
  'settings.telegramCredentialsSaveFailed': 'Не удалось сохранить данные Telegram API.',
...
const translations = {
  en: {
    ...
    'settings.telegramCredentials': 'Telegram API credentials',
    'settings.credentialsReady': 'READY',
    'settings.credentialsMissing': 'REQUIRED',
    'settings.telegramCredentialsDescription': 'Create API_ID and API_HASH at my.telegram.org, then save them here. They stay in encrypted local storage.',
    'settings.apiIdPlaceholder': 'API_ID',
    'settings.apiHashPlaceholder': 'API_HASH',
    'settings.telegramCredentialsReadFailed': 'Telegram API credentials status could not be read.',
    'settings.telegramCredentialsSaveFailed': 'Telegram API credentials could not be saved.',
