...
const russianEditorialOverrides: Partial<Record<string, string>> = {
  ...
  'hero.signInIntro': 'Вступление для входа в XMSGi',
  'assistant.askLabel': 'Спросить AI-ассистента XMSGi',
...
const translations = {
  en: {
    ...
    'hero.signInIntro': 'XMSGi sign in intro',
    'hero.sloganMain': 'Let the msg',
    'hero.sloganSub': 'wait.',
    'hero.assistant': 'AI ASSISTANT',
    'assistant.askLabel': 'Ask XMSGi Assistant',
    ...
    'chat.cannotSend': 'Can’t send messages',
    'chat.cannotSendReason': "You don't have permission to send messages to this chat.",
    ...
    'composer.effectRequired': 'Select a message effect first.',
    ...
    'settings.aboutDescription': 'XMSGi — a unique way to get your Telegram messages ready for the moment you choose.',
  ...
  ru: {
    ...
    'settings.done': 'Готово', 'settings.title': 'Настройки', 'settings.language': 'Язык', 'settings.aiAssistant': 'AI-ассистент', 'settings.aiDescription': 'Создавайте запланированные сообщения своими словами.', 'settings.on': 'ВКЛ', 'settings.off': 'ВЫКЛ', 'settings.geminiKey': 'Ключ Gemini API', 'settings.keyReady': 'КЛЮЧ ГОТОВ', 'settings.noKey': 'НЕТ КЛЮЧА', 'settings.keyDescription': 'Ваш ключ, ваша квота.', 'settings.keyPlaceholder': 'Вставьте ключ Gemini API', 'settings.noKeyYet': 'Ключ ещё не добавлен', 'settings.changeKey': 'Изменить ключ', 'settings.removeKey': 'Удалить ключ', 'settings.removeThisKey': 'Удалить этот ключ?', 'settings.getKey': 'Получить ключ API', 'settings.about': 'О приложении', 'settings.aboutDescription': 'XMSGi — особый способ подготовить сообщения Telegram к нужному моменту.', 'settings.geminiSaveFailed': 'Не удалось сохранить ключ Gemini.', 'settings.geminiRemoveFailed': 'Не удалось удалить ключ Gemini.', 'settings.assistantUpdateFailed': 'Не удалось обновить настройку AI-ассистента.',
