...
declare global {
  interface Window {
    telegram: {
      getConfig: () => Promise<{ success: boolean; config?: { API_ID?: string; API_HASH?: string; SESSION_STRING?: string }; error?: string }>;
      saveCredentials: (data: { API_ID?: string | number; API_HASH?: string; SESSION_STRING?: string; apiId?: string | number; apiHash?: string; sessionString?: string }) => Promise<{ success: boolean; config?: { API_ID?: string; API_HASH?: string; SESSION_STRING?: string }; saved?: boolean; error?: string }>;
      clearSession: () => Promise<{ success: boolean; cleared?: boolean; config?: { API_ID?: string; API_HASH?: string; SESSION_STRING?: string }; error?: string }>;
